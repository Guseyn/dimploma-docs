...
public class RungeKuttaSpecific extends RungeKutta {
    ...
    protected HashMap<String, Object> getNextInSpecificRungeKutta(
Double time,final Quaternion lambdaQuaternion,
Quaternion psiQuaternion,final Quaternion omegaOptimalQuaternion) 
throws MultiplySideException, SizeException, IndexException {
