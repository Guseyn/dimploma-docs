...
public class Main {
    ...
    private static void graph(Quaternion[] solution, Quaternion[] omega, Quaternion[] psi) throws IndexException, IOException {
        ...
        GraphString.$(x, alpha, "t", "alpha", "t", "α", 200, true, ANGELS_ALPHA_PATH);
        GraphString.$(x, beta, "t", "beta", "t", "β", 200, true, ANGELS_BETA_PATH);
        GraphString.$(x, gamma, "t", "gamma", "t", "γ", 200, true, ANGELS_GAMMA_PATH);
    }
